...
def generate_launch_description():
    ...
    # Fixed variables
    load_gripper = (
        True  # We make gripper a fixed variable, mainly because parsing the argument
    )
    ...
    return LaunchDescription(
        [
            ...
            # Simple publisher translator nodes
            Node(
                package="franka_simple_publishers",
                executable="pose_stamped_to_cartesian_impedance_goal",
            ...
            Node(
                package="franka_simple_publishers",
                executable="joint_state_to_joint_goal",
                name="joint_translator",
                namespace=ns,
                output="screen",
            ),
        ]
